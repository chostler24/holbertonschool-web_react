...
// Define the Login component, which allows users to log in
const Login = ({ logIn }) => {
  // Define state variables for email, password, and submit button enablement
  ...
  const handleChangeEmail = (email) => {
    setEmail(email);
    setEnableSubmit(email !== '' && password !== ''); // Enable the submit button if both email and password are not empty
  };
